...
# Function to close gripper safely based on motor current
def close_gripper():
    start_pos = gripper.position
    start_time = time()

    # gripper start position
    sound.speak('Gripper ' + str(start_pos))
...
def rotate(angle_deg, speed):
    ...
    """
    # For EV3, roughly 360 motor degrees = full rotation (~360° robot turn)
    # Adjust this ratio experimentally for your robot’s wheelbase
