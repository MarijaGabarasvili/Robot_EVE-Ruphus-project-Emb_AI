...
while True:
    ...
    mL.run_to_rel_pos(position_sp=20, speed_sp=BASE_SPEED)
    mR.run_to_rel_pos(position_sp=-20, speed_sp=BASE_SPEED)
    ...
    mL.run_to_rel_pos(position_sp=-40, speed_sp=BASE_SPEED)
    mR.run_to_rel_pos(position_sp=40, speed_sp=BASE_SPEED)
    mL.wait_while('running')
    mR.wait_while('running')
    time.sleep(1.5)
